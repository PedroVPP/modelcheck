...
//########################################
  ...
  static final public void satesDec() throws ParseException {
    ...
    try {
      ...
      Token tkn = jj_consume_token(IDENTIFIER);
      boolean flag = true;
      label_2:
      while (true) {
    	  State state = new State(tkn.toString());
    	  MEF.getInstance().addState(state);
    	  if (flag){
    		  MEF.getInstance().setFirstState(state);
    	  }
    	  flag = false;
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
        ...
        tkn = jj_consume_token(IDENTIFIER);
      }
  ...
  static final public void defineBody() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(Lparentheses);
      nextStates(MEF.getInstance().getState(tkn.toString()));
  ...
  static final public void nextStates(State state) throws ParseException {
    trace_call("nextStates");
    try {
      Token tkn = jj_consume_token(IDENTIFIER);
      label_5:
      while (true) {
    	  state.addChild(MEF.getInstance().getState(tkn.toString()));
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
          ;
          break;
