...
public class State {
	...
	//ao chamar os algoritmos, eles adicionariam os labels v�lidos em cada state
	...
	// Criei essa outra variável porque achei melhor que os labels sejam as expressoes
